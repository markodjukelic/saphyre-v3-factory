...
import { TestHelpers, Bundle, BigDecimal, Token } from "generated";
...
const { MockDb, Pool: PoolContract } = TestHelpers;
...
const INITIALIZE_EVENT = PoolContract.Initialize.createMockEvent({
...
describe('Initialize pool', () => {
    it('success', async () => {
        ...
        mockDb = await PoolContract.Initialize.processEvent({event: INITIALIZE_EVENT, mockDb});
