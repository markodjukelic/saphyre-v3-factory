...
export async function invokePoolCreatedWithMockedEthCalls(
  ...
  mockDb: any
    ...
    return Factory.PoolCreated.processEvent({ event: poolCreatedEvent, mockDb });
}
...
export const createAndStoreTestPool = (poolFixture: PoolFixture, chainId: number, mockDb: any): [PoolEntity, any] => {
